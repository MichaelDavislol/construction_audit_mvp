...
- установленный и запускающийся Ouroboros с поддержкой внешних extension-скиллов,
  A2A-субагентов и HTTP-клиента MCP; установка, оба рабочих сценария и примеры
  этого репозитория проверены на версии `6.61.4`;
...
Точные требования к листу и столбцам сметы приведены в [`docs/XLSX_FORMAT.md`](docs/XLSX_FORMAT.md).
